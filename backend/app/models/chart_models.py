"""
Chart specification and generation models.
"""
...
class ChartSpec(BaseModel):
    """
    Chart specification returned by LLM.
    ...
    def validate_chart_requirements(self) -> 'ChartSpec':
        ...
        if chart_type == "pie":
            ...
            if not self.y and self.aggregation == "none":
                raise ValueError(f"{chart_type.title()} charts require a y-axis column or aggregation")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "explanation": "Bar chart showing total sales by month, grouped by region for 2024",
                "title": "Sales by Month and Region (2024)"
            }
        }
        ...
        json_schema_extra = {
            "example": {
                "chart_spec": {
                    ...
                    "y": "sales",
                    "aggregation": "sum",
                    "explanation": "Monthly sales totals"
                },
                "data": [
